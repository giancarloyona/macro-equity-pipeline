...
def test_fred_fetcher_returns_valid_dataframe(mock_fred_api):
    """Garante que o fetcher retorna um DataFrame com as colunas corretas."""
    # Configurando o Mock para retornar uma série temporal fake
